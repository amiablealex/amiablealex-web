...
Add together the seasonal variation from axial tilt and the complex contribution from the equation of time, and the sun at 
the same clock-time is never in quite the same place in the sky throughout the year - it traces a distorted figure-of-eight. 
That shape is the **analemma**: the equation of time made visible, etched into the sky. The result of two independent
astronomical phenomena combining in complex ways.
